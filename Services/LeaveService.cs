    ...
    public class LeaveService : ILeaveService
    {
        ...
        public async Task<StandardResponse<LeaveView>> CreateLeave(LeaveModel model)
        {
            try
            {
                ...
                _notificationRepository.CreateAndReturn(new Notification { UserId = employeeInformation.UserId, Type = "Leave Request", Message = $"Leave Request submitted", IsRead = false });
            ...
            try
            {
                ...
                switch (status)
                {
                    case LeaveStatuses.Approved:
                        ...
                        var EmailTemplate = _emailHandler.ComposeFromTemplate(Constants.LEAVE_REVIEW_FILENAME, EmailParameters);
                        var SendEmail = _emailHandler.SendEmail(leave.EmployeeInformation.User.Email, "Leave Request Notification", EmailTemplate, "");
                    ...
                    case LeaveStatuses.Canceled:
                        ...
                        var EmailTemplateForCancelation = _emailHandler.ComposeFromTemplate(Constants.LEAVE_REVIEW_FILENAME, Emailvariables);
                        var SendCancelationEmail = _emailHandler.SendEmail(leave.EmployeeInformation.User.Email, "Leave Request Notification", EmailTemplateForCancelation, "");
                    ...
                    case LeaveStatuses.DeclineCancelation:
                        ...
                        var EmailTemplateForDeclinedCancelation = _emailHandler.ComposeFromTemplate(Constants.LEAVE_REVIEW_FILENAME, DeclineCancellationEmailvariables);
                        var SendDeclinedCancelationEmail = _emailHandler.SendEmail(leave.EmployeeInformation.User.Email, "Leave Request Notification", EmailTemplateForDeclinedCancelation, "");
