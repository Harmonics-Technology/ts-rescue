...
namespace TimesheetBE.Services.Interfaces
{
    public interface ITimeSheetService
    {
        ...
        double? GetOffshoreTeamMemberTotalPay(Guid? employeeInformationId, DateTime startDate, DateTime endDate, double totalHoursworked, int invoiceType);
        ...
        double? GetFlatTeamMemberTotalPay(Guid? employeeInformationId, DateTime startDate, DateTime endDate, double totalHoursworked, int invoiceType);
        double? GetINCTeamMemberRatePerHour(Guid? employeeInformationId);
    }
}