...
namespace TimesheetBE.Services.Interfaces
{
    public interface IExpenseService
    {
        ...
        Task<StandardResponse<PagedCollection<ExpenseView>>> ListExpenses(PagingOptions pagingOptions, Guid superAdminId, Guid? employeeInformationId = null, string search = null, DateFilter dateFilter = null);
        Task<StandardResponse<PagedCollection<ExpenseView>>> ListReviewedExpenses(PagingOptions pagingOptions, Guid superAdminId, string search = null, DateFilter dateFilter = null);
        ...
        Task<StandardResponse<PagedCollection<ExpenseView>>> ListAllApprovedExpenses(PagingOptions pagingOptions, Guid superAdminId, string search = null, DateFilter dateFilter = null);
