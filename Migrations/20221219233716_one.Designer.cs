            ...
            modelBuilder.Entity("TimesheetBE.Models.AppModels.Expense", b =>
                {
                    ...
                    b.Property<int>("EnponseTypeId")
                        .HasColumnType("int")
                        .HasColumnName("enponseTypeId");
            ...
            modelBuilder.Entity("TimesheetBE.Models.IdentityModels.User", b =>
                {
                    b.HasOne("TimesheetBE.Models.IdentityModels.User", "Client")
                        .WithOne()
                        .HasForeignKey("TimesheetBE.Models.IdentityModels.User", "ClientId")
                        .HasConstraintName("fK_Users_Users_clientId1");
