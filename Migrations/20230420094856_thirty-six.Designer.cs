...
namespace TimesheetBE.Migrations
{
    ...
    [Migration("20230420094856_thirty-six")]
    partial class thirtysix
    {
            ...
            modelBuilder.Entity("TimesheetBE.Models.AppModels.Shift", b =>
                {
                    ...
                    b.Property<Guid?>("ShiftSwappedId")
                        .HasColumnType("char(36)")
                        .HasColumnName("shiftSwappedId");
                    ...
                    b.Property<int?>("SwapStatusId")
                        .HasColumnType("int")
                        .HasColumnName("swapStatusId");
                    ...
                    b.HasIndex("ShiftToSwapId")
                        .HasDatabaseName("iX_shifts_shiftToSwapId");

                    b.HasIndex("SwapStatusId")
                        .HasDatabaseName("iX_shifts_swapStatusId");
            ...
            modelBuilder.Entity("TimesheetBE.Models.AppModels.Shift", b =>
                {
                    b.HasOne("TimesheetBE.Models.AppModels.Shift", "ShiftToSwap")
                        ...
                        .HasConstraintName("fK_shifts_shifts_shiftToSwapId");

                    b.HasOne("TimesheetBE.Models.AppModels.Status", "SwapStatus")
                        .WithMany()
                        .HasForeignKey("SwapStatusId")
                        .HasConstraintName("fK_shifts_statuses_swapStatusId");
