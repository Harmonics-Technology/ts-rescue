...
namespace TimesheetBE.Migrations
{
    ...
    [Migration("20230202173937_fifthteen")]
    partial class fifthteen
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimesheetBE.Models.AppModels.OnboradingFee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                    ...
                    b.Property<int>("OnbordingFeeTypeId")
                        .HasColumnType("int")
                        .HasColumnName("onbordingFeeTypeId");

                    b.HasKey("Id")
                        .HasName("pK_onboradingFees");

                    b.HasIndex("OnbordingFeeTypeId")
                        .HasDatabaseName("iX_onboradingFees_onbordingFeeTypeId");

                    b.ToTable("onboradingFees", (string)null);
                });

            modelBuilder.Entity("TimesheetBE.Models.AppModels.OnboradingFeeType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pK_onboradingFeeTypes");

                    b.ToTable("onboradingFeeTypes", (string)null);
                });
            ...
            modelBuilder.Entity("TimesheetBE.Models.AppModels.OnboradingFee", b =>
                {
                    b.HasOne("TimesheetBE.Models.AppModels.OnboradingFeeType", "OnbordingFeeType")
                        .WithMany()
                        .HasForeignKey("OnbordingFeeTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fK_onboradingFees_onboradingFeeTypes_onbordingFeeTypeId");

                    b.Navigation("OnbordingFeeType");
                });
