...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimesheetBE.Models.AppModels.Invoice", b =>
                {
                    ...
                    b.HasIndex("ExpenseId1")
                        .HasDatabaseName("iX_invoices_expenseId1");
            ...
            modelBuilder.Entity("TimesheetBE.Models.AppModels.Invoice", b =>
                {
                    ...
                    b.HasOne("TimesheetBE.Models.AppModels.Expense", "Expense")
                        .WithMany()
                        .HasForeignKey("ExpenseId1")
                        .HasConstraintName("fK_invoices_expenses_expenseId1");
            ...
            modelBuilder.Entity("TimesheetBE.Models.AppModels.PaySlip", b =>
                {
                    b.HasOne("TimesheetBE.Models.AppModels.Payroll", "Payroll")
                        .WithMany()
                        .HasForeignKey("PayrollId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fK_paySlips_payrolls_payrollId");
